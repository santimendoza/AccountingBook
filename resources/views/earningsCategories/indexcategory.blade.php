...
<div id="content" class="col-xs-12 col-sm-6 col-sm-offset-3">
    <div class="page-header">
        ...
        <h1>Categorías de Ingresos</h1>
    </div>
    <div class="col-sm-12">
        @foreach($categories[0] as $categorysup)
        <div class="col-sm-3">
            <div class="list-group">
                <a href="/categories/earnings/{{$categorysup->id}}" class="list-group-item active">
                ...
                <a href="/categories/earnings/{{$category->id}}" class="list-group-item">{{$category->slug}}</a>
                @endif
                @endforeach
                @endforeach
            </div>
